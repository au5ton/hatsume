    ...
    return new Promise((resolve, reject) => {
        ...
        pms.query('/myplex/account').then(account => {
            ...
            .then(res => {
                ...
                for(let i in users) {
                    //logger.log('comparing `',username_or_email,'` to `',users[i]['username'],'`')
                    //logger.log('comparing `',username_or_email,'` to `',users[i]['email'],'`')
