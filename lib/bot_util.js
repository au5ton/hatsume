                ...
                case 3: {
                    ...
                    if(valid_ids.length === 0) {
                        ...
                        Promise.all(promises).then(requests => {
                            ...
                            let promises = [];
                            for(let i in movies) {
                                promises.push(database.requests.add(movies[i]))
                            }
                            ...
                            Promise.all(promises).then(info => {
                                ...
                                if(shows.length > 0) {
                                    replies.push({
                                        text: 'You also requested TV show(s), I\'ll need you to supply some more information about them.'
                                    })
                                }
